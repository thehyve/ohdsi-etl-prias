...
| mri_lesion_positive | real | 0 | Number of lesions  that are confirmed by biopt as prostate cancer. 0 can mean both not recorded and no positive found. | Number of Cores Positive - 35918000 | Measurement |
...
| pt | varchar |  | Surgery T stadium by pathologist  Same mapping as dre | Tumor stage finding - 4300140 or TNM Prostate tumor staging - 4110284, T0 category - 4243213, Tumor stage T1a - 4130414, Tumor stage T1b - 4129126, Tumor stage T1c - 4129916, Tumor stage T2a - 4129917, Tumor stage T2b - 4127611, Tumor stage T2c - 4129127, Tumor stage T3a - 4129918, Tumor stage T3b - 4130416, Tumor stage T3c - 4129919, Tumor stage T4a - 4127612, Tumor stage T4a - 4129920, Tumor stage T4c -  4129921, Tumor stage T4d - 4129129, TX category - 4282467 |Condition occurrence |
| pn | int |  | N stadium.   9 - pnx, unknown (no prostatectomy)  0 - pn0  1 - pn1 | Tumor stage finding - 4300140 or TNM Prostate tumor staging - 4110284, pNX - 35919633, pN0 - 35919637, pN1 - 35919098, or NX category - 4195718, N0 category - 4266674, N1 category - 4203608 (erspc mapping) |Meas value or condition occurrence |
| pm | int |  | M stadium.   9 - pmx (no prostatectomy)  0 - pm0  1 - pm1 |  Tumor stage finding - 4300140 or TNM Prostate tumor staging - 4110284, MX - 45876323, M0 - 45878650, M1 - 45876322, or MX category - 4098852, M0 category - 4149726, M1 category - 4205430 |Meas value or condition occurrence |
| gleason1_rad_prost | int |  | Radical (geheel verwijderd) prostatectomy | 4096783 - "Radical prostatectomy" (should we map this to differentiate between the "normal" Gleason score and the Gleason score after radical prostatectomy?) -- map Gleason score same as basedata and fulong |Procedure| 
| gleason2_rad_prost | int |  |  |Mapping the same as gleason_1_rad_prost?| |
...
| ece | int |  | Extra capsulaire extension (yes/no/unknown)  0 - no  1 - yes  9 - unknown (do not map)  To be checked   |T3a: Prostate tumor with extracapsular extension - 4241310, Yes - 4188539, No - 4188540. Or only map 1? (as 4241310) |Condition occurrence, meas value|
| svi | int |  | seminal vesical invasion (yes/no/unknown)  0 - no  1 - yes  9 - unknown (do not map, might not be different from empty)  To be checked   | T3b: Prostate tumor invades the semical vesicle(s) - 4240691, Yes - 4188539, No - 4188540. Or only map 1? (as 4240691) |Condition occurrence, meas value|
| pos_surgical_margins | int |  | Positive surgical margins  Is the tumor completely (cleanly) removed?  0 - no  1 - yes  9 - unknown (do not map)   | Excision of malignant neoplasm - 4157779, Yes - 45878092, completely or Yes - 4188539, No - 4188540 (TODO: No means that tumor wasn't completely removed, how to map this?) |Procedure, meas value |
...
| adjuvant_radiotherapy | int |  | Radiotherapy after surgery  1 - yes  0 - no  9 - unknown  Only map 1 | Rad after surgery (SNOMED) - 45881386 or Radiation after surgery (NAACCR) - 35919395|Meas value|
