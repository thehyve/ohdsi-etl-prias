...
class CareSite(base):
    ...
    place_of_service_concept_id = Column(ForeignKey('public.concept.concept_id'))
...
class Provider(base):
    ...
    specialty_concept_id = Column(ForeignKey('public.concept.concept_id'))
    care_site_id = Column(ForeignKey('public.care_site.care_site_id'))
    year_of_birth = Column(Integer)
    gender_concept_id = Column(ForeignKey('public.concept.concept_id'))
    provider_source_value = Column(String(50))
    specialty_source_value = Column(String(50))
    specialty_source_concept_id = Column(ForeignKey('public.concept.concept_id'))
