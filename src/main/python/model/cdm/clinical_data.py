...
class ConditionOccurrence(base):
    ...
    condition_source_concept_id = Column(ForeignKey('public.concept.concept_id'))
...
class DeviceExposure(base):
    ...
    device_source_concept_id = Column(ForeignKey('public.concept.concept_id'))
...
class DrugExposure(base):
    ...
    drug_source_concept_id = Column(ForeignKey('public.concept.concept_id'))
...
class Measurement(base):
    ...
    measurement_source_concept_id = Column(ForeignKey('public.concept.concept_id'))
...
class NoteNlp(base):
    ...
    section_concept_id = Column(ForeignKey('public.concept.concept_id'))
    snippet = Column(String(250))
    offset = Column(String(250))
    lexical_variant = Column(String(250), nullable=False)
    note_nlp_concept_id = Column(ForeignKey('public.concept.concept_id'), index=True)
...
class Observation(base):
    ...
    observation_source_concept_id = Column(ForeignKey('public.concept.concept_id'))
    unit_source_value = Column(String(50))
...
class ObservationPeriod(base):
    ...
    observation_period_start_datetime = Column(DateTime, nullable=False)
    observation_period_end_date = Column(Date, nullable=False)
    observation_period_end_datetime = Column(DateTime, nullable=False)
...
class Person(base):
    ...
    gender_source_concept_id = Column(ForeignKey('public.concept.concept_id'))
    race_source_value = Column(String(50))
    race_source_concept_id = Column(ForeignKey('public.concept.concept_id'))
    ethnicity_source_value = Column(String(50))
    ethnicity_source_concept_id = Column(ForeignKey('public.concept.concept_id'))
...
class ProcedureOccurrence(base):
    ...
    procedure_source_concept_id = Column(ForeignKey('public.concept.concept_id'))
    qualifier_source_value = Column(String(50))
...
class VisitOccurrence(base):
    ...
    visit_source_concept_id = Column(ForeignKey('public.concept.concept_id'))
    admitting_source_concept_id = Column(ForeignKey('public.concept.concept_id'))
    admitting_source_value = Column(String(50))
    discharge_to_concept_id = Column(ForeignKey('public.concept.concept_id'))
...
class StemTable(base):
    ...
    domain_id = Column(ForeignKey('public.domain.domain_id'),
                       comment='A foreign key idenfifying the domain this event belongs to. The domain drives the target CDM table this event will be '
                               'recorded in.  If one is not set specify a default domain.')
    ###############
    # Fields not implemented yet in the clinical tables
